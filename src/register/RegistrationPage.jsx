...
const RegistrationPage = (props) => {
  ...
  const customRegisterCard = customLoginPage.enabled ? (customLoginPage.card.register || {}) : {};
  const stockButtonLabel = cta
    ? formatMessage(messages['create.account.cta.button'], { label: cta })
    : formatMessage(messages['create.account.for.free.button']);
  const buttonLabel = customRegisterCard.submit_label || stockButtonLabel;
  const fieldLabelProps = (messageKey, labelKey) => (customLoginPage.enabled
    ? { label: customRegisterCard.labels?.[labelKey] || formatMessage(messages[messageKey]) }
    : { floatingLabel: formatMessage(messages[messageKey]) });
          ...
          >
            ...
            <Form id="registration-form" name="registration-form">
              <NameField
                ...
                {...fieldLabelProps('registration.fullname.label', 'name')}
              />
              <EmailField
                name="email"
                ...
                {...fieldLabelProps('registration.email.label', 'email')}
              />
              {!flags.autoGeneratedUsernameEnabled && (
                <UsernameField
                  ...
                  {...fieldLabelProps('registration.username.label', 'username')}
                />
              )}
              {!currentProvider && (
                <PasswordField
                  ...
                  {...fieldLabelProps('registration.password.label', 'password')}
                />
              )}
              ...
              <StatefulButton
                ...
                type="submit"
                variant="brand"
                className={classNames('register-button mt-4 mb-4', { 'login-button-width': customLoginPage.enabled })}
                state={submitState}
                labels={{
                  default: buttonLabel,
                  pending: '',
